...
function semanticColorEntries(): [string, number][] {
  return [
    ...
    ["untrusted.mainlandAccent2", theme.untrusted.mainlandAccent2],
    ["untrusted.mainlandAccent3", theme.untrusted.mainlandAccent3],
    ["untrusted.roof", theme.untrusted.roof],
    ["untrusted.plaza", theme.untrusted.plaza],
